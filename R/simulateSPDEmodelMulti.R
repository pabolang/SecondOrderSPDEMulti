...
#' @param approx_var a vector especially useful when simulating more than one data set. The approximated variance for the replacement random variables can be computed via the function [ParabolicSPDEsMulti::variance_approx]. Alternatively a path of type String to the approx_var type vector can be used. Only of use when method is 'replacement'.
