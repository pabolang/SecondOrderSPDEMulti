...
#'
#' Plots the generated multidimensional SPDE data using the 'plotly' package, generated by [ParabolicSPDEsMulti::simulateSPDEmodelMulti].
#'
#' @param data_list the return of the the SPDE simulation, see [ParabolicSPDEsMulti::simulateSPDEmodelMulti].
